...
// export default function CalendarLayout({onProfile, burgerMenuProps}) {
...
//             </div>
//           </button>
//         <div className="text-lg font-semibold">{isGroupTab ? activeTab.group?.name : "My Calendar"}
//           </div>
//         </div>
...
//                   if (window.confirm(`Remove yourself from ${group.name}?`)) {
//                       try {
...
//             }`}
//             >
//             {tab.type === 'personal' ? 'My Calendar' : `${tab.group.name}`}
//             </button>
//         ))}
...
//                className={`"bg-green-200 px-4 py-2 rounded-full shadow-md transition-all" ${
//                isNameValid ? 'bg-green-200 text-green-800 px-4 py-2 rounded-full shadow-md hover:bg-green-300 transition-all' : 'bg-gray-300 text-gray-600 cursor-not-allowed'
//             }`}
//             >
